...
namespace HotMeals.Data.Migrations
{
    ...
    [Migration("20260313134910_Identity")]
            ...
            modelBuilder.Entity("AllergenPresence", b =>
                {
                    ...
                    b.HasIndex(new[] { "AllergenId" }, "fk__allergen_presences__allergen_id");
            ...
            modelBuilder.Entity("AllergenSensitivity", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChildId" }, "fk__allergen_sensitivities__child_id");
            ...
            modelBuilder.Entity("HotMeals.Data.School.Child", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId" }, "fk__children__user_id");
            ...
            modelBuilder.Entity("HotMeals.Data.School.MealIngredient", b =>
                {
                    ...
                    b.HasIndex(new[] { "HotMealId" }, "fk__meal_ingredients__hot_meal_id");
            ...
            modelBuilder.Entity("HotMeals.Data.School.Parent", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId" }, "fk__parents__user_id");
            ...
            modelBuilder.Entity("HotMeals.Data.School.Staff", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId" }, "fk__staff__user_id");
            ...
            modelBuilder.Entity("ParentalRelation", b =>
                {
                    ...
                    b.HasIndex(new[] { "ParentId" }, "fk__parental_relations__parent_id");
            ...
            modelBuilder.Entity("Teacher", b =>
                {
                    ...
                    b.HasIndex(new[] { "StaffId" }, "fk__teachers__staff_id");
